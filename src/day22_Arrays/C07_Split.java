...
public class C07_Split {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(gectikce));//[Java gun ,  guzellesiyor] space ler hala duruyor

        String harfler[]=str.split("");
        System.out.println(Arrays.toString(harfler));
        //[J, a, v, a,  , g, u, n,  , g, e, c, t, i, k, c, e,  , g, u, z, e, l, l, e, s, i, y, o, r]
        //hiclik yani "" ile split yaptigimiz icin string i karakterlere boler.
