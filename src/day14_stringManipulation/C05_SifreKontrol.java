...
public class C05_SifreKontrol {
    public static void main(String[] args) {
        ...
        //Yapilan her hatayi ayrı ayrı listelesin diye aşağıdaki yöntemle yaptık.
        //Eger nested if yaparsak sadece ilk hatayi verir.
        String sifre="af 14a8";

        boolean ilkHarf=false;
        if (sifre.charAt(0)>='A'&&sifre.charAt(0)<='Z'){
            ilkHarf=true;
        }else {
            System.out.println("Sifrenizini ilk harfi Buyuk harf olmali!!!");
        }
